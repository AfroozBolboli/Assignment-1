...
def get_players(game_n: int) -> List[PlayerController]:
    ...
    #p1 = AlphaBetaPlayer(1, game_n, depth=7, heuristic=heuristic2) #depth = how many moves ahead the player looks
    p2 = MinMaxPlayer(2, game_n, depth=4, heuristic=heuristic1) #depth = how many moves ahead the player looks
